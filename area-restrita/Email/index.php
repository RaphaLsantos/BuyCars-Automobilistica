            ...
            <tr>
                ...
                <td class="text-center">
                  <form action="registro.php" method="POST">
                    <input type="hidden" class="form-control" id="idEmail" name="idEmail"
                      value="<?=$email[0]?>">
                ...
                <td class="text-center">
                  <a class="dropdown-item" onclick="modalRemover(<?=$email[0]?>,'idEmailUp')">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body  ">
          <form action="remover.php" method="post">
            <input class="form-control" id="idEmailUp" name="idEmailUp" type="hidden">
