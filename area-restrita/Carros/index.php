          ...
          <table class="table table-hover">
            <thead>
              <tr>
                ...
                <th class="col-md-2">Nome carro</th>
            ...
            <tr>
                ...
                <td class="text-center">
                  <form action="registro.php" method="POST">
                    <input type="hidden" class="form-control" id="idGaleria" name="idGaleria"
                      value="<?=$galeria[0]?>">
                ...
                <td class="text-center">
                  <a class="dropdown-item" onclick="modalRemover(<?=$galeria[0]?>,'idGaleriaUp')">
    ...
    <div class=" modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header bg-danger text-white"> 
          <h1 class="modal-title fs-5" id="exampleModalLabel">Excluir Automóvel</h1>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body  ">
          <form action="remover.php" method="post">
            <input class="form-control" id="idGaleriaUp" name="idGaleriaUp" type="hidden">
